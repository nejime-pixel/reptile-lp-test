    ...
    <div className="min-h-screen relative font-sans">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="/src/assets/images/leopard_gecko_hero_1779006098556.png" 
            alt="Hero Background" 
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <ComparisonCard 
              type="Desert Type"
              title="ヒョウモントカゲモドキ"
              image="/src/assets/images/leopard_gecko_hero_1779006098556.png"
            ...
            <ComparisonCard 
              type="Forest Type"
              title="クレステッドゲッコウ"
              image="/src/assets/images/crested_gecko_hero_1779006116703.png"
      ...
      <section className="py-32 bg-brand-surface">
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            >
              <img 
                src="/src/assets/images/reptile_starter_kit_1779006131449.png" 
                alt="Starter Kit" 
